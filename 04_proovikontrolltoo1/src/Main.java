...
//Libisev keskmine
//listi sees ei saa väikse tähega kirjutada list ja array list tuleb importida
//fori+enter
//private static --> kui funktsioon
//this
//* Koosta funktsioon kolme arvu aritmeetilise keskmise leidmiseks. Katseta.
//
//* Koosta funktsioon massiivi libiseva keskmise leidmiseks. Väljundiks on massiiv, mis on sisendist kahe elemendi võrra lühem ning mille
// iga elemendi väärtuseks on sisendmassiivi vastava elemendi ning selle järgmise ja ülejärgmise elemendi keskmine.
//
//* Koosta klass, mille eksemplarile saab vastava käsuga lisada arve. Teise käsuga saab küsida nende arvude libiseva keskmise massiivi
// vastavalt eelmise punkti juhendile. Koosta kood nõnda, et uue arvu lisamisel eksemplarile tehtaks uusi arvutusi võimalikult vähe
